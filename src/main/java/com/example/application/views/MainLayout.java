...
public class MainLayout extends AppLayout {
    ...
    private SideNav createNavigation() {
        ...
        if (accessChecker.hasAccess(TeamsView.class)) {
            nav.addItem(new SideNavItem("Teams", TeamsView.class, LineAwesomeIcon.TH_LIST_SOLID.create()));
        ...
        if (accessChecker.hasAccess(EditorView.class)) {
            nav.addItem(new SideNavItem("Editor", EditorView.class, LineAwesomeIcon.EDIT_SOLID.create()));
