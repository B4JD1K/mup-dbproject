...
public class TeamsView extends Main implements HasComponents, HasStyle {
    ...
    private void constructUI() {
        ...
        H2 header = new H2("Przegląd drużyn");
        header.addClassNames(Margin.Bottom.NONE,
                Margin.Top.XLARGE,
                FontSize.XXXLARGE);

        Paragraph description = new Paragraph("Zobacz, jak drużyny e-sportowe zmieniają świat gier komputerowych.");
        description.addClassNames(Margin.Bottom.XLARGE, Margin.Top.NONE, TextColor.SECONDARY);
        headerContainer.add(header, description);

        imageContainer = new OrderedList();
        imageContainer.addClassNames(Gap.MEDIUM,
                Display.GRID,
                ListStyleType.NONE,
                Margin.NONE,
                Padding.NONE);
