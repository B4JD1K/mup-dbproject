...
@PageTitle("Players")
@Route(value = "players/:sampleBookID?/:action?(edit)", layout = MainLayout.class)
@AnonymousAllowed
public class PlayersView extends Div implements BeforeEnterObserver {

    private final String SAMPLEBOOK_ID = "sampleBookID";
    private final String SAMPLEBOOK_EDIT_ROUTE_TEMPLATE = "players/%s/edit";
    ...
    public PlayersView(SampleBookService sampleBookService) {
